...
export function ResearchFactsNote({ momentId, research }: ResearchFactsNoteProps) {
  return (
    <section className="relative flex min-h-0 flex-[2] flex-col overflow-hidden border border-[#c7ad78] bg-[#f3e6bd] p-5 pb-4 text-left text-[#1c2630] shadow-[0_16px_44px_rgba(0,0,0,.52)] sm:p-6 sm:pb-5">
    ...
    <>
      ...
      {isOpen && (
        <aside
          ...
          className="pointer-events-auto fixed inset-x-4 bottom-[7.25rem] z-30 flex max-h-[min(72dvh,38rem)] flex-col gap-3 overflow-hidden sm:inset-x-auto sm:right-6 sm:top-40 sm:bottom-28 sm:w-[20rem] sm:max-h-none"
        >
